  ...
  return (
    <section className="text-gray-600 h-full body-font bg-white">
      <div className="container px-5 py-24 mx-auto">
        ...
        <div className="flex items-center lg:w-4/5 mx-auto bg-rose-100 shadow-lg rounded-3xl border p-10 mb-10 border-gray-200 sm:flex-row flex-col">
          ...
          <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
            <h2 className="mb-3 text-3xl text-gray-800 md:text-5xl font-semibold  text-balance tracking-tight ">
              Operating System
            </h2>
        ...
        <div className="flex items-center lg:w-4/5 mx-auto bg-purple-100 shadow-lg rounded-3xl border p-10 mb-10 border-gray-200 sm:flex-row flex-col">
          <div className="w-48 h-auto sm:mr-10 inline-flex items-center justify-center rounded-full flex-shrink-0">
        ...
        <div className="flex items-center lg:w-4/5 mx-auto bg-green-100 shadow-lg rounded-3xl border p-10 mb-10 border-gray-200 sm:flex-row flex-col">
          <div className="w-48 h-auto sm:mr-10 inline-flex items-center justify-center rounded-full flex-shrink-0">
        ...
        <div className="flex items-center lg:w-4/5 mx-auto bg-teal-100 shadow-lg rounded-3xl border p-10 mb-10 border-gray-200 sm:flex-row flex-col">
          <div className="w-48 h-auto sm:mr-10 inline-flex items-center justify-center rounded-full flex-shrink-0">
